...
class View {
   ...
   static createMainPage(table) {
        ...
        container.querySelectorAll("#home")[0].addEventListener("click", function(){
            Controller.moveHome();
        })
...
class Controller {
    static selectGame() {
        ...
        let vsCpuBtn = View.config.initialPage.querySelectorAll("#vscpu")[0].addEventListener("click", function(){
            alert("現在開発中です。もうしばらくお待ち下さい。")
        })
    }
